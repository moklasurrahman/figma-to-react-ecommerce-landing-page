        ...
        <div className='mt-[103px] relative flex gap-[82px] items-center'>
            <div className="left relative w-[666px] h-[598px] bg-[#CEF0FF]">
                <div className=' flex inset-5 m-auto absolute top-[34px] left-[198px]'>
                    <img src={img1} className=' w-[440px] h-[530px] z-10 flex m-auto justify-center absolute' alt="" />
            ...
            <div className="right">
                <div>
                     <div className='flex gap-[5px]'><h3 className='text-[20px] font-[600]'>Justin Pierre</h3> 
                     <img src={imoje} className='w-[36px] h-[36px]' alt="" />
                     </div>
                    <span className='font-[400] text-[14px] mt-[1px] text-[#7E7E7E]'>Products Seller</span>
                    <p className='font-[500px] text-[20px] mt-[40px] italic w-[463px] text-[#000000]'>“In 2 years, my business went from just me and my Shop site to 40 employees, my own fulfillment center and over 22 million dollars in revenue.”</p>
                </div>
