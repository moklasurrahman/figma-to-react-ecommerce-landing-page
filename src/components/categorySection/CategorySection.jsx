    ...
    <div className=''>
        <div className=' mt-[160px] max-w-screen-xl flex flex-wrap items-center justify-between mx-auto'>
            <div className="top text-[#000002] flex justify-between w-full items-center">
                <div className="left">
                    <h1 className=' text-[36px] font-[700] font-[Spectral]'>Shop by Category</h1>
                    <p className=' text-[18px] font-[400] mt-[24px]'>Life is hard enough already. Let us make it a little easier.</p>
                </div>
                <div className="right">
