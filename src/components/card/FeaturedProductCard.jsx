...
const FeaturedProductCard = ({ product }) => {
  return (
    <div className="mt-[157px] relative">
      <div
        className=" relative w-[310px] h-[370px] bg-[#FFFDFE] border-[1px] border-[ #F5F5F5] rounded-[30px] shadow dark:bg-gray-800 dark:border-gray-700"
        style={{ boxShadow: "0px 8px 18px -7px rgba(0, 0, 0, 0.1)" }}
      >
        ...
        <div className=" font-[Poppins] mt-[200px] text-[#3B3849] flex flex-col justify-center items-center">
          <h1 className="font-[Poppins] text-[24px] font-[600]">
            {product.title}
          </h1>
          <span className=" mt-[10px]">
            <strong className="text-[24px]">{product.category}</strong>
          </span>
          <span className="mt-[30px] text-[18px] text-[#0E4B80] font-[600]">
            ${product.price} USD
          </span>
        </div>
      </div>
      <div className=" flex m-auto mt-[40px] justify-center">
        <button className=" w-[200px] h-[54px] rounded-[42px] text-center bg-[#001439] font-[600] text-[18px] text-[#FCFCFC]">
          ORDER NOW
        </button>
      </div>
    </div>
